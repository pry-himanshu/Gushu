-- Fix list_my_conversations to NOT filter by is_hidden
-- This allows the frontend to manage hidden chats (e.g. in a separate 'Hidden Chats' page)
-- while they are still filtered out of the main 'Feed' using frontend logic.
...
BEGIN
  ...
  -- Filter-out hidden removed here to allow management in UI
END $$;
